...
<head>
    ...
    <meta name="description" content="Статья о том, как непросто бывает сдать статистику и как можно легко решить эту задачу с помощью репетитора. Помощь на экзамене по статистике">
    <meta name="keywords" content="текст, статистика, предмет, вуз, институт, экзамен, студент, контрольная, статья, онлайн, помощь">

    <title> Помощь по статистике на экзамене, репетиторство </title>
...
<article>
    <section>
        <h2> Помощь по статистике каждому </h2>
                ...
                <div class="col-sm-9 col-xs-12">
                    <div class="MainContent">
                        <time>
                            ...
                            <p> Статистика не самый легкий предмет для студентов, особенно для заочников, которым дают лишь пару лекций и семинаров по этому предмету. А спрашивают обычно по полной. Ученье &mdash; это, конечно, свет, но многие задумываются: &laquo;А пригодятся ли мне эти знания в будущем?&raquo;. И действительно, часто есть более важные, срочные, интересные дела, чем разбираться, как рассчитать среднюю, моду, медиану, дисперсию или другой показатель в статистике. Конечно, мозг потренировать неплохо, но в современном мире, где всё пролетает с сумасшедшими скоростями попросту не хватает времени. В этом случае я предлагаю помощь в решении задач по статистике на экзамене, зачете или контрольной.
                            </p>
                            <p>
                                Для тех же, кто хочет всё-таки постичь азы статистики, я предлагаю репетиторство. Как показывает практика, мои студенты за несколько занятий начинают сами решать задачи. Всё просто &mdash; я не даю ничего лишнего. Только то, что надо для решения, четко, ясно и по полочкам.
                            </p>
                            <p>
                                Я делаю всё, чтобы вам было удобно и комфортно сдавать экзамен по статистике у себя в вузе)
                            </p>
