...
<head>
    ...
    <meta name="yandex-verification" content="1433b9679416c266" />
    <meta charset="UTF-8">
...
<!-- /Yandex.Metrika counter -->
	...
	<meta name="google-site-verification" content="biPTNQp_X369_6FsOc2yVYOVC7jFyDyUpq7G1GHHW0s" /><!--search console -->
    <meta name="description" content="Гарантированная помощь в решении задач по статистике онлайн на экзамене, контрольные, тесты, репетиторство.">
    <meta name="keywords" content="статистика, учеба, экзамен, репетиторство, решение, вывод, контрольная, качество, помощь, ответственность, удобно, просто, зачет, тест, онлайн, репутация">
          ...
          <div class="contener-fluid">
               <div class="row">
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <h3> Привет!</h3>
                        <h3> Меня зовут Светлана. Добро пожаловать на мой сайт! </h3>
                        <p>
                            Если Вам понадобилась помощь по СТАТИСТИКЕ, и Вы хотите, чтобы все было сделано быстро, качественно и максимально удобно для Вас, то Вы зашли по адресу)
                            <br>
                            Чем я могу Вам помочь:
                            <ul>
                                <li> <a href="reshenie_kontrolnyh.php">решение контрольных</a>, семестровых и иных работ, заданных  на дом; </li>
                                <li> <a href="online.php">ОНЛАЙН помощь</a> на экзаменах, зачетах, тестах и т.д.; </li>
                                <li> <a href="repetitorstvo.php">репетиторство</a> </li>
                            </ul>
                        </p>
                        <p>
                            Сразу отмечу, что я человек, а не организация. Я доступна онлайн 24 часа в сутки 7 дней в неделю. Я сама ответственна за решения и при необходимости внесу поправки или проконсультирую.
                            <br>
                            Работа со мной для Вас означает СДАЛ &mdash; И ЗАБЫЛ.
                            <br>
                            Почему Вам понравится работать со мной:
                        <ul>
                            <li> огромный опыт работы со статистикой;</li>
                            <li> наивысшая степень ответственности за результат;</li>
                            <li> очень высокая скорость решения онлайн;</li>
                            <li> подробные, разборчивые решения с выводами;</li>
                            <li> безупречная репутация </li>
                        </ul>
                        Я решаю только статистику (общая теория статистики и социально-экономическая статистика, статистика в психологии, медицине, социологии)!!! Но делаю это профессионально. Я делаю всё зависящее от меня, чтобы Вам было максимально удобно и просто.
                        </p>
                        </div> <!-- MainContent -->
