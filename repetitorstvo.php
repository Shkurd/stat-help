...
<head>
    ...
    <meta name="description" content="Понятные объяснения, как решать задачи по статистике, подготовка к экзамену, зачету, контрольной.">

    <title> Репетиторство по статистике </title>
            ...
            <div class="row">
                <div class="col-sm-9 col-xs-12">
                    <div class="MainContent">
                        <p>
                            Если Вы решили подготовиться к экзамену сами и разобраться, как решать задачи по статистике, то Вам, определенно, сюда.
                        </p>
                        <p>
                            Обычно я не разбираю со студентами теорию, а мы учимся решать задачи, которые будут на экзамене. У меня свои методы преподавания, которые направлены на то, чтобы неподготовленному человеку (даже не с математическим складом ума) было легко понять, откуда что взять, куда подставить и как сделать вывод. Многие из моих учеников говорили, что оказывается, статистика не такая уж и сложная. Это и есть  моя задача &mdash; сделать так, чтобы Вы справились на экзамене.
                            Что Вы получаете:
                            <ul>
                                <li> научу решать задачи быстро;</li>
                                <li> никакой «воды» — только самое нужное для решения задач;</li>
                                <li> консультации на «понятном» вам языке;</li>
                                <li> объясню формулы и решения так же просто, как написано меню в ресторане;</li>
                                <li> статистика СДАНА С ПЕРВОГО РАЗА.</li>
                            </ul>
                        </p>
                        <p>
                            Занятия возможно проводить как лично, так и через Skype, Zoom, Google Meet. Все зависит от Вашего желания и возможности до меня добраться.</br>
                            Чтобы договориться на проведение занятий, <a href="contacts.php" title="Перейти к контактам">НАПИШИТЕ МНЕ через форму обратной связи, WhatsApp, Viber, Telegram</a>, или <a href="https://vk.com/id145696127" title="Перейти на страницу преподавателя в ВК" target="_blank">Вконтакте</a>.
                        </p>
